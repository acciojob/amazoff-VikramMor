...
public class OrderController {
    ...
    public ResponseEntity<String> addOrder(@RequestBody Order order){
        System.out.println("Inside add order controller");
    ...
    public ResponseEntity<Integer> getOrderCountByPartnerId(@PathVariable String partnerId){
        ...
        Integer orderCount = orderService.getOrderCountByPartnerIdService(partnerId);
    ...
    public ResponseEntity<Integer> getCountOfUnassignedOrders(){
        ...
        Integer countOfOrders = orderService.getCountOfUnassignedOrdersService();
    ...
    public ResponseEntity<Integer> getOrdersLeftAfterGivenTimeByPartnerId(@PathVariable String time, @PathVariable String partnerId){
        ...
        Integer countOfOrders = orderService.getOrdersLeftAfterGivenTimeService(time, partnerId);
    ...
    public ResponseEntity<String> getLastDeliveryTimeByPartnerId(@PathVariable String partnerId){
        ...
        String time = orderService.getLastDeliveryTimeByPartnerIdService(partnerId);
